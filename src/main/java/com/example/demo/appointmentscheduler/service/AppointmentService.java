...
import com.example.demo.appointmentscheduler.model.TimePeroid;

// 예약 관리와 관련된 메소드 정의
public interface AppointmentService {

    // 새로운 예약을 생성하는 메소드
    void createNewAppointment(int workId, String trainerId, int customerId, LocalDateTime start);
    ...
    List<TimePeroid> getAvailableHours(String trainerId, int customerId, int workId, LocalDate date);
    ...
    boolean isAvailable(int workId, String trainerId, int customerId, LocalDateTime start);
}
