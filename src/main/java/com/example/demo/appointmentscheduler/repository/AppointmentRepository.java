...
public interface AppointmentRepository extends JpaRepository<Appointment, Integer> {
    ...
    List<Appointment> findByCustomerId(@Param("customerId") String customerId);

    // 특정 트레이너의 모든 약속을 찾습니다.
    @Query("select a from Appointment a where a.trainer.id = :trainerId") // provider를 trainer로 변경
    List<Appointment> findByTrainerId(@Param("trainerId") String trainerId); // 메서드 이름 변경

    // 특정 사용자가 취소한 모든 약속을 찾습니다.
    @Query("select a from Appointment a where a.canceler.id = :userId")
    List<Appointment> findCanceledByUser(@Param("userId") String userId);
    ...
    List<Appointment> findScheduledByUserId(@Param("userId") String userId);
    ...
    List<Appointment> findByTrainerIdWithStartInPeriod(@Param("trainerId") String trainerId, 
    ...
    List<Appointment> findByCustomerIdWithStartInPeriod(@Param("customerId") String customerId, 
                                                          @Param("dayStart") LocalDateTime startPeriod, 
    ...
    List<Appointment> findByCustomerIdCanceledAfterDate(@Param("customerId") String customerId, 
    ...
    List<Appointment> getEligibleAppointmentsForExchange(@Param("start") LocalDateTime start, 
                                                          ...
                                                          @Param("trainerId") String trainerId, // provider를 trainer로 변경
